...
public class Deck {
    ...
    // constructor for main deck
    public Deck(boolean joker) {
        // only one type of deck (one with jokers)
        deck = new ArrayList<Card>(54);
        String[] suits = {"H", "D", "S", "C"};
        // Add 52 card, 2-A for each of our four suits
        // each suit has 2-10, jack, queen, king, and ace, 52 total. then we will add the two jokers
        // use for-each loop
        for(var suit : suits) {             // for every suit in suits (var tell java to handle data type)
